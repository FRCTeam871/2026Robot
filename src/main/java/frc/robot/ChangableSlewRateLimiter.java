...
/**
 * Copy of {@link edu.wpi.first.math.filter.SlewRateLimiter} but with a setter for rate
 */
public class ChangableSlewRateLimiter {
     ...
     */
    public ChangableSlewRateLimiter(double positiveRateLimit, double negativeRateLimit, double initialValue) {
     ...
     */
    public ChangableSlewRateLimiter(double rateLimit) {
